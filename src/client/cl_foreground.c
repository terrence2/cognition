...
#define CL_THREE_IMG24 "number03"
#define CL_THREE_IMG8 "number03_alpha"
#define CL_TWO_IMG24 "number02"
#define CL_TWO_IMG8 "number02_alpha"
#define CL_ONE_IMG24 "number01"
#define CL_ONE_IMG8 "number01_alpha"
...
int fgo_cl_Initialize(void)
{
	...
	snprintf( buffer, 1024, "background%ld", ei->rng_Long( 0, CON_NUM_BACKGROUNDS ) );
